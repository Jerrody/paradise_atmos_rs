use crate::gas_mixture::constants::heat::*;
use crate::string_ref;
use auxtools::*;

pub struct MixtureNative;
...
impl MixtureNative {
    ...
    #[inline(always)]
    pub fn get_carbon_dioxide(gas_mixture: &Value) -> f32 {
        unsafe {
            gas_mixture
    ...
    #[inline(always)]
    pub fn get_nitrogen(gas_mixture: &Value) -> f32 {
        unsafe {
            gas_mixture
    ...
    #[inline(always)]
    pub fn get_toxins(gas_mixture: &Value) -> f32 {
        unsafe {
            gas_mixture
    ...
    #[inline(always)]
    pub fn get_sleeping_agent(gas_mixture: &Value) -> f32 {
        unsafe {
            gas_mixture
    ...
    #[inline(always)]
    pub fn get_agent_b(gas_mixture: &Value) -> f32 {
        unsafe {
            gas_mixture
    ...
    #[inline(always)]
    pub fn get_volume(gas_mixture: &Value) -> f32 {
        unsafe {
            gas_mixture
    ...
    #[inline(always)]
    pub fn get_temperature(gas_mixture: &Value) -> f32 {
        unsafe {
            gas_mixture
    ...
    #[inline(always)]
    pub fn get_last_share(gas_mixture: &Value) -> f32 {
        unsafe {
            gas_mixture
    ...
    #[inline(always)]
    pub fn get_fuel_burnt(gas_mixture: &Value) -> f32 {
        unsafe {
            gas_mixture
    ...
    #[inline(always)]
    pub fn get_oxygen_archived(gas_mixture: &Value) -> f32 {
        unsafe {
            gas_mixture
    ...
    #[inline(always)]
    pub fn get_carbon_dioxide_archived(gas_mixture: &Value) -> f32 {
        unsafe {
            gas_mixture
    ...
    #[inline(always)]
    pub fn get_nitrogen_archived(gas_mixture: &Value) -> f32 {
        unsafe {
            gas_mixture
    ...
    #[inline(always)]
    pub fn get_toxins_archived(gas_mixture: &Value) -> f32 {
        unsafe {
            gas_mixture
    ...
    #[inline(always)]
    pub fn get_sleeping_agent_archived(gas_mixture: &Value) -> f32 {
        unsafe {
            gas_mixture
    ...
    #[inline(always)]
    pub fn get_agent_b_archived(gas_mixture: &Value) -> f32 {
        unsafe {
            gas_mixture
    ...
    #[inline(always)]
    pub fn get_temperature_archived(gas_mixture: &Value) -> f32 {
        unsafe {
            gas_mixture
    ...
    #[inline(always)]
    pub fn set_carbon_dioxide(gas_mixture: &Value, value: f32) {
        unsafe {
            gas_mixture
    ...
    #[inline(always)]
    pub fn set_nitrogen(gas_mixture: &Value, value: f32) {
        unsafe {
            gas_mixture
    ...
    #[inline(always)]
    pub fn set_toxins(gas_mixture: &Value, value: f32) {
        unsafe {
            gas_mixture
    ...
    #[inline(always)]
    pub fn set_sleeping_agent(gas_mixture: &Value, value: f32) {
        unsafe {
            gas_mixture
    ...
    #[inline(always)]
    pub fn set_agent_b(gas_mixture: &Value, value: f32) {
        unsafe {
            gas_mixture
    ...
    #[inline(always)]
    pub fn set_volume(gas_mixture: &Value, value: f32) {
        unsafe {
            gas_mixture
    ...
    #[inline(always)]
    pub fn set_temperature(gas_mixture: &Value, value: f32) {
        unsafe {
            gas_mixture
    ...
    #[inline(always)]
    pub fn set_last_share(gas_mixture: &Value, value: f32) {
        unsafe {
            gas_mixture
    ...
    #[inline(always)]
    pub fn set_fuel_burnt(gas_mixture: &Value, value: f32) {
        unsafe {
            gas_mixture
    ...
    #[inline(always)]
    pub fn set_oxygen_archived(gas_mixture: &Value, value: f32) {
        unsafe {
            gas_mixture
    ...
    #[inline(always)]
    pub fn set_carbon_dioxide_archived(gas_mixture: &Value, value: f32) {
        unsafe {
            gas_mixture
    ...
    #[inline(always)]
    pub fn set_nitrogen_archived(gas_mixture: &Value, value: f32) {
        unsafe {
            gas_mixture
    ...
    #[inline(always)]
    pub fn set_toxins_archived(gas_mixture: &Value, value: f32) {
        unsafe {
            gas_mixture
    ...
    #[inline(always)]
    pub fn set_sleeping_agent_archived(gas_mixture: &Value, value: f32) {
        unsafe {
            gas_mixture
    ...
    #[inline(always)]
    pub fn set_agent_b_archived(gas_mixture: &Value, value: f32) {
        unsafe {
            gas_mixture
    ...
    #[inline(always)]
    pub fn set_temperature_archived(gas_mixture: &Value, value: f32) {
        unsafe {
            gas_mixture
    ...
    #[inline(always)]
    pub fn get_total_moles(gas_mixture: &Value) -> f32 {
    ...
    #[inline(always)]
    pub fn get_heat_capacity(gas_mixture: &Value) -> f32 {
        let oxygen = Self::get_oxygen(gas_mixture);
        let carbon_dioxide = Self::get_carbon_dioxide(gas_mixture);
        let nitrogen = Self::get_nitrogen(gas_mixture);
        let toxins = Self::get_toxins(gas_mixture);
        let sleeping_agent = Self::get_sleeping_agent(gas_mixture);
        let agent_b = Self::get_agent_b(gas_mixture);
